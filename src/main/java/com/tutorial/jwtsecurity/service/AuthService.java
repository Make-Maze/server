...
import com.tutorial.jwtsecurity.dto.*;
...
public class AuthService {
    ...
    @Transactional
    public TokenWithMemberResponseDTO signup(MemberRequestDto memberRequestDto) {
    ...
    @Transactional
    public TokenWithMemberResponseDTO login(MemberRequestDto memberRequestDto) {
        ...
        // 5. 토큰 발급
        return TokenWithMemberResponseDTO.builder()
